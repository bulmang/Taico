...
class HomeViewModel: ObservableObject {
    ...
    @Published var products: [Product] = [
        ...
        .init(type: .커피, title: "카페 라떼", subtitle: "Iced Caffe Latte", describe: "풍부하고 진한 농도의 에스프레소가 시원한 우유와 얼음을 만나 고소함과 시원함을 즐길 수 있는 대표적인 커피 라떼", price: "3300원", productImage: "아이스카페라떼"),
        ...
        .init(type: .블렌디드, title: "딸기 블렌디드", subtitle: "Strawberry Delight Yogurt Blended", describe: "유산균이 살아있는 리얼 요거트와 풍성한 딸기 과육이 더욱 상큼하게 어우러진 과일 요거트 블렌디드", price: "3000원", productImage: "딸기블렌디드"),
