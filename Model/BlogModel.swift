...
var blogs: [BlogModel] = [
    BlogModel(image: "image1", category: "구매 이벤트", heading: "지금 온라인 스토어에서 5만원 이상 구매시 다회용백을 드려요", author: "TAICO",site:"https://www.starbucks.co.kr/whats_new/campaign_view.do?pro_seq=2077&menu_cd="),
